        ...
        <div className={` ${classes["p-1"]} card-body`}>
          ...
          <div className={`${classes["bar-after"]} bar-after row`}>
            <div className={`col-6 ${classes["down-space"]} down-space`}>
              ...
              <div className="print-value">{props.previewData.payNo}</div>
            </div>
            <div className={`col-6 ${classes["down-space"]} down-space`}>
              <label className={`${classes["control-label"]}`}>
                Transaction Date
            ...
            <div className={`col-6 ${classes["down-space"]} down-space`}>
              <label className={`${classes["control-label"]}`}>Payment Type</label>
              <div className="print-value">{props.previewData.payType}</div>
            </div>
            {props.previewData.payBy && (
              <div className={`col-6 ${classes["down-space"]} down-space`}>
